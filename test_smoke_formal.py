...
def test_chat_trace_llm_tool_call(isolated_engine, monkeypatch):
    """LLM TOOL_CALL envelope path records tool names and route_kind in the trace."""
...
def test_tui_logging_opt_in(isolated_engine, monkeypatch):
    ...
    # Without the env flag: no sink created, ChatAgent._trace_sink is None.
    ...
    # With the env flag: sink factory called, ChatAgent._trace_sink is set.
