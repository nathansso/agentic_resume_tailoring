...
sofia.marchetti@example.com | linkedin.com/in/sofia-marchetti | github.com/smarchetti

## Summary
Computer science undergraduate training and shipping models — mostly vision, mostly the part between a working notebook and something that survives a serving budget.

## Experience

**Vector Health** — Machine Learning Intern (Jun 2026 – Aug 2026)
...
**Ardenne Polytechnic Vision Lab** — Undergraduate Research Assistant (Sep 2025 – Present)
...
**TinyDetect** (github.com/smarchetti/tinydetect) — Compact object detection
...
**Rehearsal** — Continual learning experiments
...
## Skills
Python, PyTorch, scikit-learn, TensorFlow, MLflow, NumPy, pandas, Docker, AWS,
SageMaker, ONNX, FastAPI, SQL, Weights & Biases, Git

## Education
B.S. Computer Science, Ardenne Polytechnic (Expected May 2027), GPA: 3.9

## Achievements
**Ardenne Undergraduate Research Prize** (2026) — awarded to 6 of 210 applicants
