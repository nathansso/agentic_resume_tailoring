...
julia.brandt@example.com | linkedin.com/in/julia-brandt | github.com/jbrandt-dev

## Summary
Backend-leaning full stack engineer. I like the work where the fix is measurable: a slow page, an untested module, a manual process that should not be manual.

## Experience

**Pallas Software** — Software Engineer I (Jul 2026 – Present)
...
**Fairmont University Campus IT** — Software Engineering Intern (May 2025 – Jun 2026)
...
**Queue Keeper** (github.com/jbrandt-dev/queue-keeper) — Office-hours queue app
...
**Path Finder** — Pathfinding visualizer
...
## Skills
Java, Python, TypeScript, JavaScript, React, Node.js, PostgreSQL, Spring Boot,
REST APIs, pytest, JUnit, Docker, Linux, Git, GitHub Actions

## Education
B.S. Computer Science, Fairmont University (May 2026), GPA: 3.5
