...
alex.rivera@example.com | linkedin.com/in/alex-rivera | github.com/alexrivera

## Summary
Software engineer with four years across backend services, ML systems, and data
infrastructure. Comfortable owning features end to end, from data model to
deployed service.
...
## Skills
Python, TypeScript, C#, SQL, PHP, PyTorch, XGBoost, scikit-learn, sentence-transformers,
LangChain, OpenAI API, pandas, NumPy, Airflow, Kafka, ClickHouse, Snowflake, FAISS,
FastAPI, Flask, React, Node.js, Postgres, MySQL, Redis, Docker, Kubernetes, AWS,
GitHub Actions, Nginx, Unity, Git
