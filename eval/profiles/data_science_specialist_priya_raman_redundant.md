...
priya.raman@example.com | linkedin.com/in/priya-raman | github.com/praman-stats

## Summary
Statistics undergraduate focused on applied modeling and experiment analysis. Comfortable taking a question from messy source data to a readout a non-technical team can act on.

## Experience

**Fairhaven Retail Group** — Data Science Intern (Jun 2026 – Aug 2026)
...
**Cascade State University Statistics Department** — Undergraduate Data Assistant (Sep 2025 – Present)
...
**Churn Explorer** (github.com/praman-stats/churn-explorer) — Retention analysis dashboard
...
**Grade Signal** — Course outcome analysis
...
## Skills
Python, R, SQL, pandas, NumPy, scikit-learn, statsmodels, SciPy, Jupyter,
matplotlib, seaborn, Tableau, A/B testing, Postgres, Git

## Education
B.S. Statistics, Cascade State University (Expected May 2027), GPA: 3.8

## Achievements
**2nd Place, Cascade Analytics Challenge** (2026) — forecasting track, team of 4
